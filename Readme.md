...
# Simulasi Blockchain
Implementasi sederhana dari simulasi Blockhain, mulai dari kaidah Linked List hingga sinkronasi Peer to Peer. Dibuat menggunakan [NodeJS](https://nodejs.org/) development environment:
